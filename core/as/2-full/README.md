...
It supports all the same syntax as the previous stage. Unlike previous stages, it resolves relative labels. It also has better error checking and debug info.
